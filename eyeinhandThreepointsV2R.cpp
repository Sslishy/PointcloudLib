...
int main()
{
	...
	Mat cam2robotmatrix;
	Mat out;
	cam2robotmatrix = Get3DR_TransMatrix(cam, robot);
	Eigen::Matrix4f Eigencam2robotmatrix;
	cv::cv2eigen(cam2robotmatrix,Eigencam2robotmatrix);
    
    Mat robotpose2matrix;
